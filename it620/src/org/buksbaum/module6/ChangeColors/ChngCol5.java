...
// Demo use of Swing: change between bg colors
// Text field to get new color
// Menu to get color
// Show color choice in separate window
// Bill McMillan, 10/31/02

// needs FeedbackFrame.java
 ...
 */
public class ChngCol5 extends JFrame  // main application window
{
  ...
  { public void actionPerformed(ActionEvent e)
  { pane.setBackground(Color.blue); showColor("blue"); }
  }

  class GreenListener implements ActionListener
  { public void actionPerformed(ActionEvent e)
  { pane.setBackground(Color.green); showColor("green"); }
  }

  class RedListener implements ActionListener
  { public void actionPerformed(ActionEvent e)
  { pane.setBackground(Color.red); showColor("red"); }
  }

  class CyanListener implements ActionListener
  { public void actionPerformed(ActionEvent e)
  { pane.setBackground(Color.cyan); showColor("cyan"); }
  }
  ...
  // display name of color user chose in separate window
  private void showColor(String s)
